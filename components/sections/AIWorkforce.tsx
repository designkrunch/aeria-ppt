          ...
          <RevealWrapper>
            <div className="flex flex-col gap-6 reveal reveal-delay-2">
              ...
              <div className="rounded-2xl border border-coral/20 bg-coral/5 p-6">
                <div className="stat-number text-coral mb-2">up to 20%</div>
                <div className="section-label text-muted">manpower / ops-cost reduction</div>
                <span className="tag-modeled mt-2 inline-block">Modeled target</span>
              </div>

              {/* Legend */}
              <div className="rounded-xl border border-navy-border bg-navy-surface p-5">
